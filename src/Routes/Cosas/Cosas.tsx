      ...
      <section>
        ...
        <div className='Card-container'>
          <Card
            ...
            description='lugar para descansar'
          />
          <Card
            name='polygonal waveform demo'
            link='https://dylanmartin.neocities.org/cosas/polygon/'
            description='implementación en web audio API del método de síntesis de forma de onda poligonal'
          />
          <Card
            name='ants'
            link='https://dylanmartin.neocities.org/cosas/ants/'
            description='implementación de la hormiga de langton (o lugar para tener una crisis existencial)'
          />
          <Card
            name='digitaciones para flauta contrabajo'
            link='https://dylanmartin.neocities.org/cosas/flauta/'
            description='herramienta para graficar digitaciones y exportarlas en .png'
          />
          <Card
            name='noted!'
            link='https://martindylan.github.io/noted'
            description='web app para tomar notas'
          />
          <Card
            name='pincel'
            link='https://dylanmartin.neocities.org/cosas/pincel/'
            description='otro lugar para descansar'
          />
          <Card
            name='lll'
            link='https://dylanmartin.neocities.org/cosas/lll/'
            description='livelaughlove'
          />
        </div>
      </section>
      <section>
